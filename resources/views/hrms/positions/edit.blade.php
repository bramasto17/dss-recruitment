        ...
        <header id="topbar" class="alt">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-current-item"> Edit Position</li>
                </ol>
            </div>
        </header>
        <!-- -------------- Content -------------- -->
                                    ...
                                    <div class="table-responsive">
                                        <div class="panel-body p25 pb10">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" name="name" id="input002" class="select2-single form-control" placeholder="Name" value="{{$result['name']}}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2"><a href="/positions/edit/{{$result['id']}}">
